...
def main():
    ...
    local_bmad_dir = project_root / "_bmad"
    fallback_bmad_dir = Path(__file__).resolve().parent.parent
    bmad_dir = local_bmad_dir if local_bmad_dir.exists() else fallback_bmad_dir
