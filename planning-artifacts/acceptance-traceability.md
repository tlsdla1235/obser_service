...
| project key는 active project로만 검증되고 raw key를 저장하지 않는다 | Epic 3 / Story 3.1 | `api-surface.md`, `database-schema.md` | `ProjectKeyVerificationService`, `ProjectRepository` | `ProjectKeyVerificationServiceTest` |
